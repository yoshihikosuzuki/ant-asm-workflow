...
cd 03-bwa/ &&
    BWA=$(sbatch -d afterany:${MAKE_INDEX} run_bwa.sh | cut -f 4 -d' ') &&
    cd ..
...
srun -p compute -c 1 --mem 1G -t 1:00:00 -d afterany:${BUSCO},${MERQURY},${BWA},${MAPQV},${ASSET},${TELOMERE} --wait=0 sleep 1s
